...
if not redis:get("MuteAll:"..msg.chat_id) then
sendText(msg.chat_id, msg.id,'▪️ گروه قفل میباشد لطفا پیامی ارسال نکنید ! \n جهت خرید گروه به ایدی زیر مراجعه کنید \n @poker_alfa' , 'md')
redis:set("MuteAll:"..msg.chat_id,true)
end
else
...
sendText(msg.chat_id,msg.id,'`▪️ سیستم ربات بروز شد. \n @poker_alfa`','md')
end 
...
local text = '`▪️ گروه  '..Company.title..' در لیست گروه های مدیریتی قرار ندارد. جهت خرید ربات برای گروا خود با ایدی زیر در ارتباط باشید \ @poker_alfa`'
 sendText(msg.chat_id, msg.id,text,'md')
else
...
sendText(msg.chat_id ,msg.id,"`▪️ گروه به صورت نامحدود شارژ شد. \n @poker_alfa`",'md')
...
sendText(msg.chat_id, msg.id,'▪️ آخرین نسخه سورس به پیوی سازنده ربات ارسال شد. \n @poker_alfa','md')
end
if matches == 'backup' then
sendDocument(Sudoid, 0, 0, 1, nil, './Cli.lua', dl_cb, nil)
sendDocument(Sudoid, 0, 0, 1, nil, './Config.lua', dl_cb, nil)
sendDocument(Sudoid, 0, 0, 1, nil, './Api.lua', dl_cb, nil)
sendText(msg.chat_id, msg.id,'`▪️ Tʜᴇ ʟᴀᴛᴇsᴛ ᴠᴇʀsɪᴏɴ ᴏғ ᴛʜᴇ sᴏᴜʀᴄᴇ ᴡᴀs sᴇɴᴛ ᴛᴏ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴏғ ᴛʜᴇ ʀᴏʙᴏᴛ. \n @poker_alfa`','md')
end
...
sendText(msg.chat_id, msg.id,  "`▪️ ربات از گروه خارج میشود. \n جهت خرید گروه با ایدی زیر در ارتباط باشید \n\n @poker_alfa`", 'md' )
Left(msg.chat_id, TD_ID, 'Left')
end
if matches == 'leave' then
sendText(msg.chat_id, msg.id,  "`▪️ The robot leaves the group. \n for buy group cal this id: \n\n @poker_alfa`", 'md' )
Left(msg.chat_id, TD_ID, 'Left')
end
